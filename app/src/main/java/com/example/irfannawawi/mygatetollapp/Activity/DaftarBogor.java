...
public class DaftarBogor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_bogor);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(DaftarBogor.this));
    ...
    private void tampilGateTollJakarta() {
        ...
        //Siapkan request
        Call<ResponseTol> tolCall = apiServices.request_bogor();
        //kirim request
            ...
            public void onResponse(Call<ResponseTol> tolcall, Response<ResponseTol> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status) {
                        ...
                        // kalau tidak true
                        Toast.makeText(DaftarBogor.this, "Tidak ada daftar gerbang tol", Toast.LENGTH_SHORT).show();
                    }
                }
            }
