...
public class DaftarJakarta extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_jakarta);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(DaftarJakarta.this));
    ...
    private void tampilGateTollJakarta() {
        ...
        //Siapkan request
        Call<ResponseTol> tolCall = apiServices.request_jakarta();
        //kirim request
            ...
            public void onResponse(Call<ResponseTol> tolcall, Response<ResponseTol> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status) {
                        ...
                        AdapterGateToll adapter = new AdapterGateToll(DaftarJakarta.this, data_tol);
                        recyclerView.setAdapter(adapter);
                    } else {
                        // kalau tidak true
                        Toast.makeText(DaftarJakarta.this, "Tidak ada daftar gerbang tol", Toast.LENGTH_SHORT).show();
                    }
                }
            }
