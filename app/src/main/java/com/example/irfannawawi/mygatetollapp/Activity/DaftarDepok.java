...
public class DaftarDepok extends AppCompatActivity {
    ...
    private void tampilGateTollJakarta() {
        ...
        //Siapkan request
        Call<ResponseTol> tolCall = apiServices.request_depok();
        //kirim request
            ...
            public void onResponse(Call<ResponseTol> tolcall, Response<ResponseTol> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status) {
                        ...
                        AdapterGateToll adapter = new AdapterGateToll(DaftarDepok.this, data_tol);
                        recyclerView.setAdapter(adapter);
                    } else {
                        // kalau tidak true
                        Toast.makeText(DaftarDepok.this, "Tidak ada daftar gerbang tol", Toast.LENGTH_SHORT).show();
                    }
                }
            }
