...
public class DaftarTangerang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_daftar_tangerang);
        ...
        recyclerView.setLayoutManager(new LinearLayoutManager(DaftarTangerang.this));
    ...
    private void tampilGateTollJakarta() {
        ...
        //Siapkan request
        Call<ResponseTol> tolCall = apiServices.request_tangerang();
        //kirim request
            ...
            public void onResponse(Call<ResponseTol> tolcall, Response<ResponseTol> response) {
                ...
                if (response.isSuccessful()) {
                    ...
                    if (status) {
                        ...
                        AdapterGateToll adapter = new AdapterGateToll(DaftarTangerang.this, data_tol);
                        recyclerView.setAdapter(adapter);
                    } else {
                        // kalau tidak true
                        Toast.makeText(DaftarTangerang.this, "Tidak ada daftar gerbang tol", Toast.LENGTH_SHORT).show();
                    }
                }
            }
